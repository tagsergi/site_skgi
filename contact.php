                ...
                <div class="col-md-6 col-sm-12 col-12">
                    <div class="padding-10-perc"> 
                        ...
                        <div class="section-heading text-left">
                            <small class="grey-color font-size-20 font-weight-normal">Contactez nous</small>
                            <h3 class="semi-bold font-size-32">Commençons un projet ensemble</h3>
                        ...
                        <form method="post" action="#" class="primary-form-3 mt-45">
                            ...
                            <div>
                                <button type="submit" class="button-md button-primary text-uppercase ml-0">Envoyer le Message</button>
                            </div>
                        </form>
                    </div>
                </div>
